...
- #### The followings are the different microservices which are inter-communicating through http requests:
  ...
  - ### [Flight and Search Service](https://github.com/debjyoti-m28/FlightsAndSearchService)
      - Responsible for CRUD operations on flight and filtering flights based on different criteria.
  - ### [Ticket Booking Service](https://github.com/debjyoti-m28/AirlineTicketBookingService)
      - Responsible for Booking, Updating and Cancelling flight ticket.
  - ### [Reminder Service]()
      - Responsible for sending emails for confirmed ticket bookings and sending reminders about flight.
